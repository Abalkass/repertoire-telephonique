...
/**
 * <code>AddressBook</code> est une classe représentant un carnet d'adresses.
 * C'est une liste de contacts, dont chaque contact possède une information.
 * Cette liste est enregistrée dans une {@link Properties}.<br>
 * 
 * <code>AddressBook</code> hérite de la classe {@link JFrame} pour créer une fenêtre
 * graphique et propose ainsi une GUI.
 * Cette fenêtre contient des boutons et items permettant :
 * <ul>
 * 		<li>d'enregistrer le carnet d'adresses sur le disque dur de l'utilisateur,</li>
 * 		<li>d'ajouter un nouveau contact,</li>
 * 		<li>ou de supprimer un contact existant.</li>
 * </ul> 
 * 
