...
/**
 * <code>SaveInfoTxtPaneController</code> est un écouteur de type {@link DocumentListener}
 * qui écoute les changements faits dans une {@link JTextPane} pour
 * l'enregistrer comme valeur sur une {@link Properties}. On peut retrouver par une
 * sélection dans une {@link JList}, l'attribut du {@link Properties} à laquelle est fait ce changement.
 * 
