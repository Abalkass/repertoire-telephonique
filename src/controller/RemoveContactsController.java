...
/**
 * <code>RemoveContactsController</code> est un écouteur de type {@link ActionListener}, 
 * qui supprime un contact dans une {@link Properties}. Ce contact est obtenu par une
 * sélection faite dans une {@link JList}.<br>
 * Avant de réaliser cette suppression, on demande une confirmation avec
 * une boite de dialogue {@link JOptionPane} qu'on instancie à une {@link JFrame}.
 * 
