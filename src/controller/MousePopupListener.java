...
/**
 * <code>MousePopupListener</code> est un {@link WindowAdapter},
 * qui affiche un {@link JPopupMenu} lorsque l'on fait un click droit
 * d'une souris sur une {@link JList}. Ce {@link JPopupMenu} est un menu contextuel.<br>
 * Elle sélectionne en même temps l'élément de la {@link JList} où on
 * fait le click droit.
 * 
