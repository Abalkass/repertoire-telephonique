...
/**
 * ChangeInfoContactsController est un écouteur de type {@link ListSelectionListener}
 * qui change les informations d'un contact lors sa sélection dans {@link JList}.
 * Les informations du contact vont être affichées dans un {@link JTextPane}.
 * Toutes les informations de chaque contact sont contenues dans une {@link Properties}.<br>
 * Cette classe permet aussi de changer le texte d'un {@link JMenuItem} lorsqu'on
 * sélectionne un contact sur la {@link JList}.
 * 
